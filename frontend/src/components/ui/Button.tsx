...
export function Button({
  ...
  const classes = `show-button inline-flex min-h-12 items-center justify-center gap-2 rounded-lg border px-5 py-3 text-sm font-black uppercase tracking-[0.14em] transition duration-200 hover:-translate-y-0.5 hover:scale-[1.01] active:translate-y-0 active:scale-[0.98] disabled:translate-y-0 disabled:cursor-not-allowed disabled:opacity-45 ${tones[tone]} ${className}`;
