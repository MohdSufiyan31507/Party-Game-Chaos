import type { GamePrompt } from "../registry/types";

export const mvpSampleData: Record<string, GamePrompt[]> = {
  "guess-movie": [
    {
  ...
  "heads-up": [
    {
      ...
      helperText: "Hold phone on forehead. Tilt support comes later with real sensors.",
    },
    {
      prompt: "Plot Twist",
      answer: "Plot Twist",
